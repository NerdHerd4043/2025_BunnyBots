...
public class Constants {
  public static final class DriveConstants {
    ...
    public static final class SwerveModules {
      ...
      public static final SwerveModuleConfig backRight = new SwerveModuleConfig(2, 12, 22, true);
      public static final SwerveModuleConfig frontLeft = new SwerveModuleConfig(3, 13, 23, true);
